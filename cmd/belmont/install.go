...
func runInstall(args []string) error {
	...
	fmt.Println("  2. UX Design  - Derive the design authority (screens, flows, contract)")
	fmt.Println("  3. Tech Plan  - Create technical implementation plan")
	fmt.Println("  4. Implement  - Implement next milestone (full pipeline)")
	fmt.Println("  5. Next       - Implement next single task (lightweight)")
	fmt.Println("  6. Verify     - Run verification and code review")
	fmt.Println("  7. Status     - View progress")
	fmt.Println("  8. Reset      - Reset state and start fresh")
	fmt.Println("  9. Cleanup    - Archive completed features, reduce token bloat")
	fmt.Println("")
