...
- `.belmont/TECH_PLAN.md` — the six Kind B rules that make self-hosting safe: binary pinning, the no-reinstall window between M1 and M11, barbell model tiers, zero Go dependencies, proposals-before-contract-change, and Tier 2 evals for any prose change.
