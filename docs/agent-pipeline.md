...
**File**: `.agents/belmont/codebase-agent.md` | **Model**: Opus (default — override per feature via models.yaml)
...
**File**: `.agents/belmont/design-agent.md` | **Model**: Opus (default — override per feature via models.yaml)
...
**File**: `.agents/belmont/implementation-agent.md` | **Model**: Opus (default — override per feature via models.yaml)
...
**File**: `.agents/belmont/verification-agent.md` | **Model**: Opus (default — override per feature via models.yaml)
...
**File**: `.agents/belmont/code-review-agent.md` | **Model**: Opus (default — override per feature via models.yaml)
